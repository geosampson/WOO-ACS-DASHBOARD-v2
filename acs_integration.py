...
class ACSShippingTab(ttk.Frame):
    ...
    def create_all_shipments_tab(self):
        ...
        # Sticker position buttons
        ttk.Button(control_frame, text="🏷️ 3-Sticker (Full)", 
                  command=self.create_3sticker_pdf).pack(side='right', padx=2)
        ttk.Button(control_frame, text="🏷️ Top", 
                  command=lambda: self.create_single_sticker_pdf(1)).pack(side='right', padx=2)
        ttk.Button(control_frame, text="🏷️ Middle", 
                  command=lambda: self.create_single_sticker_pdf(2)).pack(side='right', padx=2)
        ttk.Button(control_frame, text="🏷️ Bottom", 
                  command=lambda: self.create_single_sticker_pdf(3)).pack(side='right', padx=2)
